...
Of course, nothing goes perfectly on the first try. When adding the new switch to the RADIUS server, it turned out there was no DNS record for it yet. And as the old adage goes:
